...
Modified date: 2025-10-16 19:13
---
# GEODATA
...
| 项目名称                                                         | 地理区域 | 介绍                              |
| ------------------------------------------------------------ | ---- | ------------------------------- |
| [GeoIP - Hackl0us](https://github.com/Hackl0us/GeoIP2-CN/)   | CN   | 🇨🇳 小巧精悍、准确、实用 GeoIP2 数据库 🇨🇳 |
| [geoip- Loyalsoldier](https://github.com/Loyalsoldier/geoip) |      |                                 |
| [geoip - NobyDa](https://github.com/NobyDa/geoip)            |      | 用于代理工具的 GeoIPCN 的增强版。           |
...
| 项目名称                                                          | 介绍                               |
| ------------------------------------------------------------- | -------------------------------- |
| [loon_data - Loon0x00](https://gitlab.com/Loon0x00/loon_data) | Loon mmdb and default rule files |
